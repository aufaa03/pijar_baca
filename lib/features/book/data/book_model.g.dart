...
Book _bookDeserialize(
  ...
  object.dateAdded = reader.readDateTimeOrNull(offsets[3]);
  object.dateFinished = reader.readDateTimeOrNull(offsets[4]);
  object.description = reader.readStringOrNull(offsets[5]);
  object.id = id;
  object.status =
      _BookstatusValueEnumMap[reader.readStringOrNull(offsets[6])] ??
          BookStatus.reading;
  object.title = reader.readStringOrNull(offsets[7]);
  object.totalPages = reader.readLongOrNull(offsets[8]);
  return object;
}
...
const _BookstatusValueEnumMap = {
  ...
  r'wishlist': BookStatus.wishlist,
};
...
extension BookQueryWhere on QueryBuilder<Book, Book, QWhereClause> {
  ...
  QueryBuilder<Book, Book, QAfterWhereClause> statusEqualTo(BookStatus status) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterWhereClause> statusNotEqualTo(
      BookStatus status) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension BookQueryFilter on QueryBuilder<Book, Book, QFilterCondition> {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> dateAddedIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> dateAddedIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'dateAdded',
      ));
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> dateFinishedIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> dateFinishedIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'dateFinished',
      ));
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> dateFinishedEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'dateFinished',
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> dateFinishedGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> dateFinishedLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> dateFinishedBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BookQuerySortBy on QueryBuilder<Book, Book, QSortBy> {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> sortByDateFinished() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateFinished', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> sortByDateFinishedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BookQuerySortThenBy on QueryBuilder<Book, Book, QSortThenBy> {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> thenByDateFinished() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateFinished', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> thenByDateFinishedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateFinished', Sort.desc);
    });
  }
...
extension BookQueryWhereDistinct on QueryBuilder<Book, Book, QDistinct> {
  ...
  QueryBuilder<Book, Book, QDistinct> distinctByDateFinished() {
    return QueryBuilder.apply(this, (query) {
...
extension BookQueryProperty on QueryBuilder<Book, Book, QQueryProperty> {
  ...
  QueryBuilder<Book, DateTime?, QQueryOperations> dateFinishedProperty() {
    return QueryBuilder.apply(this, (query) {
