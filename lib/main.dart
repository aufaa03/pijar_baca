...
import 'package:pijar_baca/core/services/notification_service.dart';
import 'package:pijar_baca/features/app_gate.dart';
import 'package:pijar_baca/core/theme/app_theme.dart'; // Import tema baru
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Pijar Baca',
      debugShowCheckedModeBanner: false,
      theme: AppTheme.lightTheme, // Gunakan tema light
      darkTheme: AppTheme.darkTheme, // Gunakan tema dark
      themeMode: ThemeMode.system, // Otomatis ikuti sistem
      home: const AppGate(),
    );
  }
}